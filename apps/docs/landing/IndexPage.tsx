      ...
      {open && (
        <div role="menu" {...stylex.props(styles.themeMenu)}>
          {(['light', 'dark', 'system'] as const).map((mode) => (
            <button key={mode} type="button" role="menuitem" {...stylex.props(styles.themeItem)} onClick={() => pick(mode)}>
      ...
      <div {...stylex.props(styles.wrap)}>
        <header {...stylex.props(styles.header)}>
          ...
          <nav {...stylex.props(styles.nav)}>
            <a href="/docs" {...stylex.props(styles.navLink)}>Docs</a>
            <a href="/docs/components/accordion" {...stylex.props(styles.navLink)}>Components</a>
            <a href="/changelog" {...stylex.props(styles.navLink)}>Changelog</a>
            <a href="https://github.com/madeui/ui" {...stylex.props(styles.navLink)}>GitHub</a>
            <ThemeMenu />
          </nav>
        </header>
        ...
        <section {...stylex.props(styles.hero)}>
          ...
          <h1 {...stylex.props(styles.h1)}>
            Components, made yours<i {...stylex.props(styles.dot)} />
          </h1>
          ...
          <div {...stylex.props(styles.cta)}>
            <a href="/docs/installation" {...stylex.props(styles.btn, styles.btnSolid)}>Get Started</a>
            <a href="/docs/components/accordion" {...stylex.props(styles.btn, styles.btnGhost)}>View Components</a>
          </div>
        ...
        <section {...stylex.props(styles.bento)} aria-label="Live component previews">
          <div {...stylex.props(styles.cell, styles.sink)}><KitchenSink /></div>
          <div {...stylex.props(styles.cell)}><ApiKeyCard /></div>
          <div {...stylex.props(styles.cell)}><ComposeCard /></div>
          <div {...stylex.props(styles.cell)}><BackupCard /></div>
          <div {...stylex.props(styles.cell)}><RsvpCard /></div>
          <div {...stylex.props(styles.cell)}><FocusCard /></div>
          <div {...stylex.props(styles.cell)}><ReviewerCard /></div>
          <div {...stylex.props(styles.cell)}><ShortcutsCard /></div>
        </section>
        ...
        <footer {...stylex.props(styles.footer)}>
          ...
          <div {...stylex.props(styles.footerLinks)}>
            <a href="/docs" {...stylex.props(styles.footerLink)}>Docs</a>
            <a href="/changelog" {...stylex.props(styles.footerLink)}>Changelog</a>
            <a href="https://github.com/madeui/ui" {...stylex.props(styles.footerLink)}>GitHub</a>
          </div>
        </footer>
      </div>
    </div>
...
const styles = stylex.create({
  ...
  navLink: {
    ...
    color: { default: colors.mutedForeground, [HOVER]: { default: null, ':hover': colors.foreground } },
  ...
  pill: {
    alignItems: 'center',
    borderColor: { default: colors.border, [HOVER]: { default: null, ':hover': colors.mutedForeground } },
  ...
  bento: {
    ...
    gridTemplateColumns: {
      ...
      '@media (max-width: 61.25rem)': 'repeat(2, 1fr)',
