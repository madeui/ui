...
export function Table({
  style,
  ...props
}: Omit<React.ComponentPropsWithoutRef<'table'>, 'className' | 'style'> &
  StyleXStyleProps) {
  return (
...
export function TableHeader({
  style,
  ...props
}: Omit<React.ComponentPropsWithoutRef<'thead'>, 'className' | 'style'> &
  StyleXStyleProps) {
...
export function TableBody({
  style,
  ...props
}: Omit<React.ComponentPropsWithoutRef<'tbody'>, 'className' | 'style'> &
  StyleXStyleProps) {
...
export function TableFooter({
  style,
  ...props
}: Omit<React.ComponentPropsWithoutRef<'tfoot'>, 'className' | 'style'> &
  StyleXStyleProps) {
...
export function TableRow({
  style,
  ...props
}: Omit<React.ComponentPropsWithoutRef<'tr'>, 'className' | 'style'> &
  StyleXStyleProps) {
...
export function TableHead({
  style,
  ...props
}: Omit<React.ComponentPropsWithoutRef<'th'>, 'className' | 'style'> &
  StyleXStyleProps) {
...
export function TableCell({
  style,
  ...props
}: Omit<React.ComponentPropsWithoutRef<'td'>, 'className' | 'style'> &
  StyleXStyleProps) {
...
export function TableCaption({
  style,
  ...props
}: Omit<React.ComponentPropsWithoutRef<'caption'>, 'className' | 'style'> &
  StyleXStyleProps) {
